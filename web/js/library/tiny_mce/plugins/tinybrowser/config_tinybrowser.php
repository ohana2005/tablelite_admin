...
//session_start();
$tinybrowser['sessioncheck'] = 'is_login'; //name of session variable to check
...
$tinybrowser['path']['image'] = '/newssite/www/upload/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/newssite/www/upload/media/'; // Media files location
$tinybrowser['path']['file']  = '/newssite/www/upload/files/'; // Other files location
