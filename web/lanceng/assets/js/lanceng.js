...
//RESPONSIVE SIDEBAR
	$("button.show-sidebar").click(function () {
        $('.sidebar-scroll-button').toggleClass("sidebar-scroll-button-mobile");
...
//SIDEBAR MENU
	$('#sidebar-menu > ul > li > a').click(function () {
		var jElement = $(this).next();
		var isVisible = jElement.is(':visible');
		$('li', '#sidebar-menu').removeClass('selected');
		$('ul ul:visible', '#sidebar-menu').slideUp('fast');
		if (!isVisible) {
			$(this).closest('li').addClass('selected');
			jElement.slideDown('fast');
		}
		return ($(this).closest('li').find('ul > li').size() < 1);
	});
